...
var newHeader = document.querySelector(".js-header-message");
var greenPizzaPad = document.querySelector(".js-pad-green");
var redPizzaPad = document.querySelector(".js-pad-red");
var bluePizzaPad = document.querySelector(".js-pad-blue");
var yellowPizzaPad = document.querySelector(".js-pad-yellow");
...
function padHandler(event) {
  ...
  if (!color) return;
  var pad = pads.find(function (_ref) {
...
function activatePad(color) {
  var pad = pads.find(function (_ref2) {
  ...
  pad.sound.play();
  setTimeout(function () {
    return pad.selector.classList.remove("activated");
  }, 500);
}
...
function checkRound() {
  if (playerSequence.length === maxRoundCount) {
    ...
    setTimeout(function () {
      return playComputerTurn(roundCount, 1000);
    });
  }
}
